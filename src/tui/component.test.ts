// Proof for the persistent-component substrate: a Counter whose state survives
// the per-frame tree rebuild, with lifecycle (onMount/onUnmount/onFocus/onBlur)
// and key routing through the live instance. No TTY — pure assertions.
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { Box, Button, Slot } from './nodes.ts';
...
test('persistent component: state survives rebuild + lifecycle fires', () => {
