// Board placement invariants for Islanders — the pure spatial predicates that decide where a
// piece may legally go, given who owns what. No rendering, no resource/turn logic (that lives
// in islanders.ts); this is the shared rule core the board editor uses now and the eventual
