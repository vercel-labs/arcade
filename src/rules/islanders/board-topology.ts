// The static board graph for the base 19-hex Islanders board: which vertices (settlement/city
...
// (Euler: 54 − 72 + 19 + 1 = 2). This is the integer-ID version of islandersatron's
// construction-time dedup — no hand-listed adjacency arrays. See docs/islanders.md §3.3.
