// Core Islanders primitives — no rendering, no board geometry, no game logic. Just the
...
// costs, and the action / prompt unions. Base 3–4 player game. See docs/islanders.md.
...
// default for AI in the rules layer — see docs/islanders.md §3.6.
export type IslandersAction =
  ...
  | { type: 'withdrawCounterTrade'; player: number }
  | { type: 'rejectTrade' }
