...
export { ISLANDERS_BUILDING_BEATS, ISLANDERS_ROAD_BEATS, islandersDropProgress, type IslandersBuildingBeat, type IslandersRoadBeat } from './islanders-choreography.ts';
