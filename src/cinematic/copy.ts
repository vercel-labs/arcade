...
export const CINEMATIC_CHAPTERS: readonly CinematicChapterCopy[] = [
  ...
  { title: ['Different minds.', 'Endless possibilities.'], body: ['Everything you see is open source.', 'Have an idea? You move.'] },
  { title: ['Every player', 'has a tell.'], body: ['Discover the hidden tendencies', 'of your favourite models.'] },
