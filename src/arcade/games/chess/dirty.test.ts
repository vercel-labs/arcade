// Test of the chess dirty-flag state machine (the logic the orchestrator gate
// relies on). Asserts: first frame paints, idle frames skip, a camera change
...
test('dirty-flag state machine: still frames idle, changes re-arm, moves stay dirty', () => {
