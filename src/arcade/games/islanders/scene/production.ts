...
//
// The test bed keeps its own board and building map instead of a live IslandersState, so this
// mirrors the engine's private distributeProduction (rules/islanders/islanders.ts) over those structures
...
import { hexNodes, NUM_HEXES } from '../../../../rules/islanders/board-topology.ts';
import { type BoardSetup } from '../../../../rules/islanders/setup.ts';
import { type PlayerColor, type Resource, TERRAIN_RESOURCE } from '../../../../rules/islanders/types.ts';
