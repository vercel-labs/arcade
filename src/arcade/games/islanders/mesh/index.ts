// The Islanders mesh library: everything the scene needs to draw a board, a tile, the pieces, the
...
export type { RGB } from '../../../../game-visuals/islanders/index.ts';
export { AnimatedTileMeshCache, animatedTileMesh, robberMarkerMesh, robberMesh, tileBackMesh, tileMesh } from '../../../../game-visuals/islanders/index.ts';
